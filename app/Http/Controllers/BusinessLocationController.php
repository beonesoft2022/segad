  ...
  class BusinessLocationController extends Controller
  {
    ...
    public function store(Request $request)
    {
      ...
      try {
        ...
        $contactData['name'] = $input['name'];
        $contactData['contact_id'] = $input['location_id'];
        $contactData['type'] = 'both';
        $contactData['contact_id'] = $input['location_id'];
        $contactData['supplier_business_name'] = $input['name'];
        $contactData['mobile'] = $input['mobile'];


//        $inputcontact['business_id'] = $business_id;
//        $inputcontact['created_by'] = $request->session()->get('user.id');
//        $inputcontact['type'] = 'both';
//        $inputcontact['supplier_business_name'] = $input['name'];
//        $inputcontact['mobile'] = '0100000';
//        $inputcontact['contact_id'] = $input['location_id'];
