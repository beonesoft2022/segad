...
//      $contact = Contact::find($contact_id);
      ...
      $transaction = Transaction::create([
        ...
        'total_before_tax' => $invoice_total['total_before_tax'] ? $invoice_total['total_before_tax'] : $final_total,
        ...
        'tax_amount' => $invoice_total['tax'] ? $invoice_total['tax'] : 0,
        ...
        'is_direct_sale' => !empty($input['is_direct_sale']) ? $input['is_direct_sale'] : 1,
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
      ...
      if ($transaction_type == 'sell_return') {
        ...
        if ($transaction->payment_status == 'paid' && !empty($il->invoice_heading_paid)) {
          ...
          $output['invoice_heading'] .= 'due ' . $il->invoice_heading_not_paid;
        }
      }
