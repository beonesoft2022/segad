...
@section('content')
  ...
  <section class="content no-print">
    {!! Form::open(['url' => action('InvoicedStockTransferController@store'), 'method' => 'post', 'id' => 'stock_transfer_form' ]) !!}
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-condensed"
                ...
                <tr>
                  ...
                  <th class="@if (!auth()->user()->can('transfer.canviewprice')) hide @endif"> السعر</th>
                  <th class="col-sm-2 text-center">
                    @lang('sale.subtotal')
                  </th>
                ...
                <tr class="text-center">
                  <td colspan="3"></td>
                  <td>
                    <div class="pull-right"><b>@lang('sale.total'):</b> <span id="total_adjustment">0.00</span>
                    </div>
                  </td>
                </tr>
                </tfoot>
